    ...
    <div className="w-full h-full flex flex-col items-center relative bg-w pt-12 pb-10 md:px-20">
      <div className='w-full flex flex-col items-center'>
        <div className='flex justify-start px-14'>
          <h2 className='text-neutral-600 text-2xl font-extrabold mb-6 text-center'>Hãy chọn phương án đúng đắn của bạn</h2>
        </div>
        <div className='h-full flex justify-center items-center px-14 lg:flex-nowrap flex-wrap drop-shadow-md'>
          <div className='flex justify-center flex-col text-center'>
            ...
            <p className='text-sm mb-1'>Có được kế hoạch cho tương lai của con bạn. Có thể nâng cấp cho tương lai</p>
                ...
                <div className='w-full h-full '>
                  ...
                  <div className='absolute z-10'>
                    <div className='flex pl-4 mt-4 '>
                      <p className='px-4 py-1 bg-white rounded-xl text-[#8450ff] font-semibold'>Pro</p>
                    </div>
                    
                    <div className='flex flex-col mt-6 px-6 w-full h-full'>
                      <p className='text-[14px] text-white'>WELEGEND là nền tảng phát trực tuyến cao cấp lớn nhất với hơn 100.000 giờ</p>
                      <h2 className='md:text-4xl text-3xl mt-4 font-bold text-white'>200.000đ<span className='font-light text-sm'> /tháng</span></h2>
                    </div>  

                  </div>
                  <div className='absolute z-10 flex flex-col items-start md:top-[37%] top-[35%] w-full h-full '>
                    <div className='pt-12 pl-6'>
                      <div className='text-sm px-2 py-1'> <FontAwesomeIcon icon={faCheck} color='green' className='mr-2'/><span >3-5 ngày không giới hạn truy cập toàn bộ khóa học</span></div>
                      <div className='text-sm px-2 py-1'> <FontAwesomeIcon icon={faCheck} color='green' className='mr-2'/><span >3-5 ngày không giới hạn truy cập</span></div>
                      <div className='text-sm px-2 py-1'> <FontAwesomeIcon icon={faCheck} color='green' className='mr-2'/><span >3-5 ngày không giới hạn truy cập </span></div>
                      <div className='text-sm px-2 py-1'> <FontAwesomeIcon icon={faCheck} color='green' className='mr-2'/><span >3-5 ngày không giới hạn truy cập </span></div>
                    </div>
                  </div>
                  <div className='absolute z-10 bottom-0 left-1/2 transform -translate-x-1/2 flex w-[50%] text-center'>
                    <div className='border-solid border-[1px] border-indigo-600 w-full rounded-xl mb-4'>
                      <p className='text-[#5d3aae] font-semibold px-4 py-2 hover:bg-[#5d3aae] hover:text-white hover:rounded-xl transition-all duration-300'>BẮT ĐẦU NGAY</p>
                    </div>
                  </div>
            ...
            <div className='w-full h-full p-8 flex items-center justify-center'>
              <div className='w-full h-full bg-white rounded-lg relative overflow-hidden min-w-[300px] max-w-[370px] drop-shadow-2xl'>
                <div className='w-full h-full '>
                  ...
                  <div className='absolute z-10'>
                    <div className='flex pl-4 mt-4 '>
                      <p className='px-4 py-1 bg-white rounded-xl text-[#8450ff] font-semibold'>Vip Pro</p>
                    </div>
                    
                    <div className='flex flex-col mt-6 px-6 w-full h-full'>
                      <p className='text-[14px] text-white'>WELEGEND là nền tảng phát trực tuyến cao cấp lớn nhất với hơn 100.000 giờ</p>
                      <h2 className='md:text-4xl text-3xl mt-4 font-bold text-white'>1.200.000đ<span className='font-light text-sm'> /năm</span></h2>
                    </div>  
            ...
            <div className='w-full h-full p-8 flex items-center justify-center'>
              <div className='w-full h-full bg-white rounded-lg relative overflow-hidden min-w-[300px] max-w-[370px] drop-shadow-2xl'>
                <div className='w-full h-full '>
                  ...
                  <div className='absolute z-10'>
                    <div className='flex pl-4 mt-4 '>
                      <p className='px-4 py-1 bg-white rounded-xl text-[#8450ff] font-semibold'>Medium</p>
                    </div>
