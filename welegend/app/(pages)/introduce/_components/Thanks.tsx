...
export function Thanks() {
  return (
    <div className="md:flex md:items-center text-center sm:block sm:mx-10 sm:my-8 lg:mx-28 lg:my-24 mx-5 my-3 gap-28 ">
      ...
      <div className="md:w-3/4 text-center">
        <h1 className="sm:text-[25px] md:text-[34px] font-bold sm:mb-2 md:mb-8 2xl:mb-0">
          Lời Cảm Ơn
        </h1>
        <p className="text-left md:mb-4 sm:mb-2 sm:text-[14px] md:text-[18px]">
