    ...
    <div className="">
      <div className="w-screen h-max">
        ...
        <div className="relative">
          <div
            className="animate-ripple1 delay-[-4000ms] opacity-30 w-full h-[36px] block absolute bg-repeat-x"
            style={{
              background: `url(${wave.src})`,
            }}
          ></div>
          <div
            className="animate-ripple2 delay-[-4000ms] opacity-50 w-full h-[36px] block absolute bg-repeat-x"
            style={{
              background: `url(${wave.src})`,
            }}
          ></div>
          <div
            className="animate-ripple3 delay-[-4000ms] w-full h-[36px] block absolute bg-repeat-x"
            style={{
              background: `url(${wave.src})`,
            }}
          ></div>
        ...
        <div className="bg-[#035392] text-white">
