...
export function TruthStory() {
  ...
  return (
    ...
    >
      ...
      {tmp.map((item) => (
        <>
          <div className="relative md:p-16 p-7 ">
            <Image
            ...
            <div className="absolute translate-y-[-40%] top-1/2 left-1/2 translate-x-[-50%] md:translate-x-0 h-72 min-w-[300px] bg-white mr-20 rounded-md text-ellipsis overflow-hidden m-auto">
              <div className="px-10 py-7">
                ...
                <p className="text-[12px] md:text-[16px] my-3">
                  Tại một ngôi làng nhỏ ở Việt Nam, cô bé Linh, đam mê câu
                  chuyện cổ tích, nhận ra giáo dục qua video có thể chạm đến
                  nhiều trẻ em hơn. Linh quyết định tạo ra một ứng dụng để chia
                  sẻ những câu chuyện truyền thống đẹp, mở ra cánh cửa tri thức
                  cho các em nhỏ.
                </p>
                <Button
                  type="text"
