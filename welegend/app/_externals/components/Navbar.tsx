  ...
  return (
    ...
    >
      <div className="flex">
        ...
        <h1 className="logo_text text-sky-600 text-3xl font-normal">LEGEND</h1>
      </div>
      <div
        ...
        {isOpenFind ? (
          <div className="px-[1%] py-3 w-1/2 flex justify-between items-center bg-gray-100 rounded-xl expanding-width">
            <input
              ...
              className="text-black flex-[1] text-[17px] font-medium outline-none bg-transparent placeholder-gray-500"
            />
